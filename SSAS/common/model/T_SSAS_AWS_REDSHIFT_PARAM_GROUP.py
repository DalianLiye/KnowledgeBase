...
class T_SSAS_AWS_REDSHIFT_PARAM_GROUP(Base):
    __tablename__ = 'SSAS_AWS_REDSHIFT_PARAM_GROUP'

    _account_id = Column("account_id", String, primary_key=True)
    _param_group_name = Column("param_group_name", String, primary_key=True)
    ...
    def param_group_name(self, value):
        self._param_group_name = value
    ...
    def __repr__(self):
        return f"<MyTable(account_id='{self._account_id}', " \
               f"param_group_name='{self._param_group_name}', " \
