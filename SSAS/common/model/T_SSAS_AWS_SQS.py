...
class T_SSAS_AWS_SQS(Base):
    __tablename__ = 'SSAS_AWS_SQS'

    _account_id = Column("account_id", String, primary_key=True)
    _sqs_name = Column("sqs_name", String, primary_key=True)
    ...
    @sqs_name.setter
    def sqs_name(self, value):
        self._sqs_name = value
