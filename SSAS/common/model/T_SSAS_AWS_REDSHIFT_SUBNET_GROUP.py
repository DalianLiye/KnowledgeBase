...
class T_SSAS_AWS_REDSHIFT_SUBNET_GROUP(Base):
    __tablename__ = 'SSAS_AWS_REDSHIFT_SUBNET_GROUP'

    _account_id = Column("account_id", String, primary_key=True)
    _subnet_group_name = Column("subnet_group_name", String, primary_key=True)
    _subnet_group_status = Column("subnet_group_status", String)
    _vpc_id = Column("vpc_id", String)
    ...
    def subnet_group_status(self, value):
        self._subnet_group_status = value
    ...
    def __repr__(self):
        return f"<MyTable(account_id='{self._account_id}', " \
               f"subnet_group_name='{self._subnet_group_name}', " \
               f"subnet_group_status='{self._subnet_group_status}', " \
