...
aws s3 ls s3://bucket_name_XXXXXX/

/usr/local/bin/aws s3 ls --recursive --summarize --human-readable s3://bucket_name_XXXXXX/

aws s3api list-objects-v2 --bucket bucket_name_XXXXXX > /A/B/liye1.txt